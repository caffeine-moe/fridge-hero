...
data class OpenFoodFactsProduct(
    ...
    fun asFoodItem(): FoodItem =
        FoodItem().apply {
            this.name = this@OpenFoodFactsProduct.productNameEnglish
            this.barcode = this@OpenFoodFactsProduct.code
            this.brand = this@OpenFoodFactsProduct.brands
        }
}